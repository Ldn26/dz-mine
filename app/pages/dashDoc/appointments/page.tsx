  ...
  return (
    <div className="overflow-x-visible">
      <input
        type="text"
        placeholder="Search..."
        className="w-[90%] md:w-[300px] h-[40px] rounded-lg m-8 bg-gray-200 text-gray-600 placeholder-gray-500 px-4 focus:outline-none focus:ring-2 mr-[8%] focus:ring-gray-400"
        value={search}
